...
try:
	os.system("gcc ./hash.c ./q1/*.c -fsanitize=address -fsanitize=undefined -o dist/scratch/q1.bin")
except:
...
try:
	os.system("gcc ./hash.c ./q2/*.c -fsanitize=address -fsanitize=undefined -o dist/scratch/q2.bin")
...
try:
	os.system("gcc ./hash.c ./q3/*.c -fsanitize=address -fsanitize=undefined -o dist/scratch/q3.bin")
except:
